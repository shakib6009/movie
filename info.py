...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<db_username>:banglafilx@banglafilx.00pzhw3.mongodb.net/?retryWrites=true&w=majority&appName=Banglafilx")

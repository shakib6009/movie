...
USERNAME = environ.get('USERNAME', "https://t.me/Shakib6009") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002399488732'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/banglafilx2025')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002344960542').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://<db_username>:Shakib@islam6009@banglafilx.00pzhw3.mongodb.net/?retryWrites=true&w=majority&appName=Banglafilx")
DATABASE_NAME = environ.get('DATABASE_NAME', "Banglafilx")
